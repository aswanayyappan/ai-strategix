...
export function AuthPage({ onAuth, onBack, onLogin, theme, setTheme }: AuthPageProps) {
          ...
          <div className="bg-card border border-border rounded-3xl p-6 md:p-10 animate-fade-in-up">
            ...
            <div className="text-center mb-6 md:mb-8">
              ...
              <p
                ...
                style={{ fontFamily: 'var(--font-body)' }}
              >
                Create your account to access AI Business Strategist
              </p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <button
                onClick={onAuth}
                className={`w-full px-6 py-4 rounded-full transition-all flex items-center justify-center gap-3 border min-h-[48px] ${isDark
                  ? 'bg-white hover:bg-black hover:text-white text-black border-white'
                  : 'bg-black hover:bg-white hover:text-black text-white border-black'
                  }`}
                style={{ fontFamily: 'var(--font-body)' }}
